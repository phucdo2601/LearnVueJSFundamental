            ...
            <div class="section options">
              ...
              <div class="row">
                <div class="col-4" v-for="option in jobOptions" :key="option.id">
                  <div
                    class="block"
                    :style="{backgroundColor: quiz.jobs.includes(option.id) ? 'var(--primary)' :'' }"
                  >
                    <label class="option">
  ...
  export default {
    ...
    methods: {
        onSubmit() {
            ...
            if (this.quiz.fullName.length < 6 || this.quiz.fullName.length > 30) {
                this.error ={
                    text: "Look failed! Full name should be at least 6-30 characters",
                    status: true,
                }
            } else if (this.quiz.fullName.length > 5 && this.quiz.fullName.length < 31 ){
                this.success ={
                    text: "Look Great!",
                    status: true,
                }
